...
public class Lesson3 {
        ...
        do {
            ...
            do {
                ...
                if (userAnswer > guessedNumber) {
                    tryCountsLost++;
                    System.out.printf("Загаданное число меньше.\nУ Вас осталось попыток: %d\n\n", (tryCounts - tryCountsLost));
                } else if (userAnswer < guessedNumber) {
                    tryCountsLost++;
                    System.out.printf("Загаданное число больше.\nУ Вас осталось попыток: %d\n\n", (tryCounts - tryCountsLost));
                } else {
            ...
            if (userAnswer != guessedNumber) System.out.printf("Неверно! Было загадано число: %d.\n" +
                    "Вы истратили все попытки, но так и не угадали число. Вы проиграли.\n\n", guessedNumber);
    ...
    public static void playGameGuessTheWord(){
        ...
        System.out.printf("Hello! You must guess some word.\nHint: %s\n", wordsAndHints[wordNumber][1]);
